...
const StyledButton = styled.button `
    ...
    return styled.css `
            ...
            font-family: var(--Button-fontFamily, ${defaultTheme.vars.fontFamily.body});
            ...
            ` : styled.css `
                border-radius: var(--Button-radius, ${defaultTheme.vars.radius.sm});
            `}
            &::after, &::before {
    ...
    ${props => {
    return theme.mergeStyleOverrides('TuiButton', props.$options);
}}
`;
