...
var Textarea_styled = require('./Textarea.styled.js');
...
const Textarea = React.forwardRef((inProps, ref) => {
    ...
    return React.createElement(Textarea_styled.StyledTextareaRoot, { className: classNamesRoot, "$options": props, onClick: () => {
