...
const StyledCheckbox = styled.label `
    ...
    return styled.css `
            ...
            font-family: var(--Checkbox-fontFamily, ${defaultTheme.vars.fontFamily.body});
            ...
            & .${_} {
                ...
                & .${_}-inner {
                    ...
                    ` : styled.css `
                        border-radius: var(--Checkbox-radius, ${defaultTheme.vars.radius.sm});
                    `}
     ...
     ${props => {
    return theme.mergeStyleOverrides('TuiCheckbox', props.$options);
}}
`;
