...
const StyledSwitch = styled.label `
    ...
    let borderColor = outlined ?
        variant === 'filled' ? defaultTheme.vars.palette.neutral.dark : defaultTheme.vars.palette.neutral.container
        : 'transparent';
    let borderColorChecked = outlined ?
        variant === 'filled' ? palette.dark : palette.main
        : 'transparent';
    let foreColor, handleBackground, handleForeColor, background, backgroundRipple, hoverOpacity, activeOpacity, handleForeColorChecked, handleBackgroundChecked, backgroundChecked;
    foreColor = defaultTheme.vars.palette.surface.onDark;
    switch (variant) {
        case 'filled':
            handleBackground = defaultTheme.vars.palette.common.white;
            handleBackgroundChecked = defaultTheme.vars.palette.common.white;
    ...
    return styled.css `
            ...
            font-family: var(--Switch-fontFamily, ${defaultTheme.vars.fontFamily.body});
            ...
            & .${_} {
                ...
                & .${_}-track-container {
                    ...
                    & .${_}-track {
                        ...
                        ` : styled.css `
                            border-radius: var(--Switch-radius, ${defaultTheme.vars.radius.sm});
                        `}
                        transition: 
                            opacity 150ms ease 0ms,
                ...
                & .${_}-handle-container {
                    ...
                    & .${_}-handle {
                        ...
                        ` : styled.css `
                            border-radius: calc(var(--Switch-handleRadius, ${defaultTheme.vars.radius.sm}) - 2px);
                        `}
     ...
     ${props => {
    return theme.mergeStyleOverrides('TuiSwitch', props.$options);
}}
`;
