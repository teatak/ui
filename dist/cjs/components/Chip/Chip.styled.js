...
const StyledChip = styled.div `
    ...
    ${props => {
    return theme.mergeStyleOverrides('TuiChip', props.$options);
}}
`;
const StyledChipDelete = styled.span `
    ...
    ${props => {
    return theme.mergeStyleOverrides('TuiChipDelete', props.$options);
}}
`;

exports.StyledChip = StyledChip;
exports.StyledChipDelete = StyledChipDelete;
