...
const colorPaletteGray = (baseColor, i) => {
...
const colorPalette = (baseColor, i) => {
...
const colorPaletteDarkGray = (baseColor, i) => {
...
const colorPaletteDark = (baseColor, i) => {
